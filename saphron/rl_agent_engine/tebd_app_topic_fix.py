...
# Extract all unique topics from dataset and map to indices
...
class DQNAgent:
    ...
    def act(self, state, prev_action=None):
        ...
        topics = [topic_to_index[q['topic']] for q in QUESTION_BANK]
...
def submit():
    ...
    # 🔁 Convert back to list before saving to session
    session["knowledge"] = list(next_state)
